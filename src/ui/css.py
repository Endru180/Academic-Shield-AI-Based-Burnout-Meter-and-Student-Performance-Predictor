...
# Shield-only crop of the Academic Shield logo (square viewBox, centred on the
# shield + checkmark) so it stays crisp at favicon sizes. The full wordmark logo
# still renders in-page via render_shield_logo().
_FAVICON_SVG = (
    '<svg width="64" height="64" viewBox="-2 2 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
